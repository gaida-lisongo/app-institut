...
import ResultatActions from "@/components/resultats/ResultatActions";

// Composant Résultats - Focus sur promotion et année
const ResultatsPage = ({ onBack }: { onBack: () => void }) => {
    const { anneeInfo, promotionInfo, parcours } = useResultat();
    console.log("Promotion data : ", promotionInfo);
    console.log("Pacrous data : ", parcours);

    if(!anneeInfo || !promotionInfo || !parcours) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4 animate-slideInLeft">
            ...
            <div className="space-y-6">
                ...
                {parcours?.statut === 'Terminé' ? (
                    <ResultatActions promotionInfo={promotionInfo} />
                ) : (
                    <div className="bg-gray-800 rounded-2xl shadow-lg p-6 text-center">
                        ...
                        <p className="text-gray-400 mb-6">
                            Les résultats seront disponibles une fois que vous aurez regulariser votre situation financière.
                        </p>
                        <div className="bg-yellow-900/20 border border-yellow-800 rounded-lg p-4">
                            <p className="text-yellow-400 text-sm">
                                📊 En attente - Approchez vous de votre bureau du jury.
                            </p>
                        </div>
                    </div>
                )}
